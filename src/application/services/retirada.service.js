...
class RetiradaService {
    ...
    selectLastFiveRetiradas() {
        return __awaiter(this, void 0, void 0, function* () {
            const retiradas = yield this.retiradaRepository.selectLastFive();
            if (!retiradas || !retiradas.length) {
                throw new appError_1.default("Últimas retiradas não encontradas", status.NOT_FOUND);
            }
            return retiradas;
        });
    }
